...
<body>
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <th>Jumlah Cuti :</th>
                <td><?= $cuti ?> hari x Rp. <?= number_format($data->u_makan + $data->u_transport) ?></td>
            </tr>
            <tr>
                <th>Jumlah Sakit :</th>
                <td><?= $sakit ?> hari x Rp. <?= number_format($data->u_makan + $data->u_transport) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>Rp. <?= number_format(($absen * $data->u_makan + $data->u_transport) + ($cuti * $data->u_makan + $data->u_transport) + ($sakit * $data->u_makan + $data->u_transport)) ?></td>
            </tr>
        </table>
        <br><br><br>
        <small>

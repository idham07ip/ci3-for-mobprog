            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="card">
                    <div class="card-header"> <?= $title ?> </h3>
                        <a style="float: right;" href="<?= base_url('pegawai/sakit_add') ?>" class="btn btn-sm btn-primary">Tambah data</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($d->status == 'diajukan') { ?>
                                                <a onclick="return confirm('apakah anda yakin ingin menghapus pengajuan sakit ini?')" href="<?= base_url('pegawai/sakit_delete/' . $d->id_sakit) ?>" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                            <?php } ?>

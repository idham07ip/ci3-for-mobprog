...
<body>
    <!-- <img class="wave" src="<?php echo base_url(); ?>assets/img/bgwave.png"> -->
    <div class="container">
        <!-- <div class="img">
            <lottie-player src="<?= base_url(); ?>assets/img/9579-delivery.json" background="transparent" speed="1" style="width: 500px; height: 400px;" loop autoplay></lottie-player>
        </div> -->
        <div class="login-content ml-auto">
            <form action="<?= base_url('auth/aksi_login') ?>" method="post">
                <img src="<?php echo base_url(); ?>assets/img/unbin.png">

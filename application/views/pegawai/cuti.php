        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            <div class="callout callout-info">
              ...
              Izin Cuti hanya diberikan untuk pegawai yang sudah bekerja selama 1 tahun<br>
              Izin Tidak masuk diberikan untuk siapa saja ( Dipotong uang makan & transport ) <br>
              ...
              <div class="card-body table-responsive">
                <table id="table" class="table table-bordered table-striped text-center">
                  ...
                  <tbody>
                    <?php $no = 1;
                    foreach ($data as $d) {
                      $cek = $this->db->query(" select date(waktu_pengajuan) as mulai, selesai_pengajuan as akhir from cuti where id_cuti = '$d->id_cuti' ")->row();
                    ?>
                      <tr>
                        <td width="1%"><?= $no++ ?></td>

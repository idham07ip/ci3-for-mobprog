...
<body onload="" class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">

    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand  navbar-light" style="background-color: #035397">
      <!-- Left navbar links -->
      <ul class="navbar-nav">
        <li class="nav-item">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #035397">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="info">
            <a href="#" class="d-block"><small>Welcome :</small><br> <b><?= $this->session->userdata('nama') ?></b></a>
          </div>
        </div>
    ...
    <!-- /.content-wrapper -->
    <footer class="main-footer" style="background-color: white; color: Black">
